    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                Section(header: Text("Spoofing Behavior"), footer: Text("When moving along a route, occasionally pause at intersections for a few seconds to simulate real-world traffic. Helps bypass anti-bot detections.")) {
